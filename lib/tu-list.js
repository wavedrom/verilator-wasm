...
// The translation units linked into verilator_bin (count pinned in
// verilator.json as expectedTuCount).
//
...
// directory holds one extra .o file (V3Scoreboard.o), built but not on the
// link line. Enumerating the directory is how an earlier probe undercounted.
...
module.exports = {parseTuList, resolveTuSource};
